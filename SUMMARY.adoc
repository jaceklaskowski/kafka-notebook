...
... link:kafka-ControllerEvent-AutoPreferredReplicaLeaderElection.adoc[AutoPreferredReplicaLeaderElection]
... link:kafka-ControllerEvent-Startup.adoc[Startup]
... link:kafka-ControllerEvent-TopicDeletion.adoc[TopicDeletion]
