...
.. link:kafka-consumer-Consumer.adoc[Consumer Contract]
...
.. link:kafka-consumer-internals-AbstractCoordinator.adoc[AbstractCoordinator]
...
. link:kafka-consumer-PartitionAssignor.adoc[PartitionAssignor Contract]
...
.. link:kafka-consumer-AbstractPartitionAssignor.adoc[AbstractPartitionAssignor]
...
.. link:kafka-clients-Metadata-Listener.adoc[Metadata Update Listener]
