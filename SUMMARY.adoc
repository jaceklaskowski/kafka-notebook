...
. link:kafka-server-DynamicConfigManager.adoc[DynamicConfigManager -- Dynamic Configuration Management]
.. link:kafka-server-ConfigHandler.adoc[ConfigHandler Contract -- Configuration Change Handlers]
...
. link:kafka-server-KafkaRequestHandlerPool.adoc[KafkaRequestHandlerPool -- Pool of Daemon KafkaRequestHandler Threads]
