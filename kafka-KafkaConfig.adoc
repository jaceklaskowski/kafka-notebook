...
Used when `KafkaApis` is requested to <<kafka-KafkaApis.adoc#getTopicMetadata, getTopicMetadata>> and <<kafka-KafkaApis.adoc#handleTopicMetadataRequest, handleTopicMetadataRequest>>
