...
NOTE: `KafkaConsumer` API offers other constructors that in the end use the above public 3-argument constructor that in turn passes the call on to the private internal constructor.
