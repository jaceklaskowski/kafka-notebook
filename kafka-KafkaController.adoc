...
1. <<deregisterLogDirEventNotificationListener, Unsubscribes from changes to /log_dir_event_notification znode>>
...
=== [[deregisterLogDirEventNotificationListener]] Unsubscribing from Changes to /log_dir_event_notification ZNode -- `deregisterLogDirEventNotificationListener` Internal Method
