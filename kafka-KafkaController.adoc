...
`onControllerResignation` does the following in order:

1. <<deregisterIsrChangeNotificationListener, Unsubscribes from changes to /isr_change_notification znode>>
...
=== [[deregisterIsrChangeNotificationListener]] Unsubscribing from Changes to /isr_change_notification ZNode -- `deregisterIsrChangeNotificationListener` Internal Method
