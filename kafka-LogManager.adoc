...
`LogManager` is used to create a <<kafka-server-ReplicaManager.adoc#logManager, ReplicaManager>>, a <<kafka-DynamicLogConfig.adoc#logManager, DynamicLogConfig>>, a <<kafka-TopicConfigHandler.adoc#logManager, TopicConfigHandler>>.
