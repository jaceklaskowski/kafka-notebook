...
`Metadata` is <<creating-instance, created>> right when link:kafka-consumer-KafkaConsumer.adoc#creating-instance[KafkaConsumer], link:kafka-KafkaProducer.adoc#creating-instance[KafkaProducer], link:kafka-KafkaAdminClient.adoc#creating-instance[KafkaAdminClient] and link:kafka-AdminClient.adoc#create[AdminClient] are created.
