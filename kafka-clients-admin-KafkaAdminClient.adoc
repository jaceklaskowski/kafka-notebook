...
=== [[electPreferredLeaders]] Electing Preferred Partition Leaders -- `electPreferredLeaders` Method
...
NOTE: `electPreferredLeaders` is part of the <<kafka-clients-admin-AdminClient.adoc#electPreferredLeaders, AdminClient Contract>> to elect the preferred partition leaders.
