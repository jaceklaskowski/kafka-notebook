...
NOTE: `electPreferredLeaders` is part of the <<kafka-clients-admin-AdminClient.adoc#electPreferredLeaders, AdminClient Contract>> to trigger <<kafka-feature-preferred-replica-election.adoc#, preferred replica leader election>>.
