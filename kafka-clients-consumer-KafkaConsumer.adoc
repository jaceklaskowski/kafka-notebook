...
Used to create a <<kafka-NetworkClient.adoc#metadata, NetworkClient>> (for the <<client, ConsumerNetworkClient>>), the <<client, ConsumerNetworkClient>> itself, the <<coordinator, ConsumerCoordinator>> and <<fetcher, Fetcher>>
