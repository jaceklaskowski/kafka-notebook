...
NOTE: link:kafka-clients-consumer-internals-ConsumerCoordinator.adoc[ConsumerCoordinator] is the default `AbstractCoordinator` in Apache Kafka's Consumer API.
