...
* `ConsumerCoordinator` link:kafka-clients-consumer-internals-ConsumerCoordinator.adoc#commitOffsetsSync[commitOffsetsSync] and link:kafka-clients-consumer-internals-ConsumerCoordinator.adoc#fetchCommittedOffsets[fetchCommittedOffsets]
* `Fetcher` is requested for link:kafka-clients-consumer-internals-Fetcher.adoc#getTopicMetadata[topic metadata] or link:kafka-clients-consumer-internals-Fetcher.adoc#retrieveOffsetsByTimes[retrieveOffsetsByTimes]
====
