...
NOTE: `ensureFreshMetadata` is used when `ConsumerCoordinator` does link:kafka-consumer-ConsumerCoordinator.adoc#onJoinComplete[onJoinComplete], link:kafka-consumer-ConsumerCoordinator.adoc#performAssignment[performAssignment] and link:kafka-consumer-ConsumerCoordinator.adoc#poll[poll].
...
* `ConsumerCoordinator` link:kafka-consumer-ConsumerCoordinator.adoc#commitOffsetsSync[commitOffsetsSync] and link:kafka-consumer-ConsumerCoordinator.adoc#fetchCommittedOffsets[fetchCommittedOffsets]
