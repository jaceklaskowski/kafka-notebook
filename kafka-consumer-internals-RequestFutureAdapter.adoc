...
* `FindCoordinatorResponseHandler` is requested to <<kafka-consumer-internals-AbstractCoordinator-FindCoordinatorResponseHandler.adoc#onFailure, onFailure>>
...
| <<kafka-consumer-internals-AbstractCoordinator-FindCoordinatorResponseHandler.adoc#, FindCoordinatorResponseHandler>>
