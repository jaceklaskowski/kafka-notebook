...
=== [[sendRequestsToBrokers]] Sending Controller Requests To All Brokers -- `sendRequestsToBrokers` Method
...
`sendRequestsToBrokers` <<sendLeaderAndIsrRequest, sends LeaderAndIsr requests out to all brokers>>.

`sendRequestsToBrokers` <<sendUpdateMetadataRequests, sends UpdateMetadata requests out to all brokers>>.

`sendRequestsToBrokers` <<sendStopReplicaRequests, sends StopReplica requests out to all brokers>>.
