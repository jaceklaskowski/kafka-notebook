...
`LogSegment` uses the following configuration properties (as given to <<open, open a segment>>):
...
* <<kafka-log-LogConfig.adoc#randomSegmentJitter, segment.index.bytes>> for the <<rollJitterMs, rollJitterMs>>
