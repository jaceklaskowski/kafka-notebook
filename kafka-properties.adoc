...
a| [[authorizer.class.name]] Fully-qualified class name of the <<kafka-server-authorizer-Authorizer.adoc#, Authorizer>> for <<kafka-server-KafkaApis.adoc#authorize, authorization>>
