...
[[keys]]
[[handlers]]
.KafkaApis's API Keys and Their Handlers
...
| DeleteRecords
| [[DeleteRecords]] <<handleDeleteRecordsRequest, handleDeleteRecordsRequest>>
...
| ListOffsets
| [[ListOffsets]] <<handleListOffsetRequest, handleListOffsetRequest>>
...
| [[OffsetForLeaderEpoch]] <<handleOffsetForLeaderEpochRequest, handleOffsetForLeaderEpochRequest>>
