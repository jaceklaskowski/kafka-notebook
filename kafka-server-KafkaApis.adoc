...
`KafkaApis` is given an optional link:kafka-server-authorizer-Authorizer.adoc[Authorizer] when <<creating-instance, created>> that is used for the following:
...
NOTE: `authorizedOperations` is used when...FIXME
