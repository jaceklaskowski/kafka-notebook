...
* [[authorizer]] <<kafka-security-Authorizer.adoc#, Authorizer>> (optional)
...
=== [[authorize]] Authorizing Principal for Operation on Resource -- `authorize` Internal Method
...
`authorize` simply requests the <<authorizer, Authorizer>> to <<kafka-security-Authorizer.adoc#authorize, authorize>> the given `Operation` on the given `Resource` in the `RequestChannel.Session`.
...
=== [[handleDeleteAclsRequest]] Handling DeleteAcls Request -- `handleDeleteAclsRequest` Handler
...
`handleDeleteAclsRequest`...FIXME

NOTE: `handleDeleteAclsRequest` is used when...FIXME
...
`handleDescribeConfigsRequest`...FIXME

NOTE: `handleDescribeConfigsRequest` is used when...FIXME

=== [[handleDescribeAclsRequest]] Handling DescribeAcls Request -- `handleDescribeAclsRequest` Handler

[source, scala]
----
handleDescribeAclsRequest(
  request: RequestChannel.Request): Unit
----

`handleDescribeAclsRequest`...FIXME

NOTE: `handleDescribeAclsRequest` is used when...FIXME
