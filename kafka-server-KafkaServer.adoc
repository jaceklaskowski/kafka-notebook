...
`copyKafkaConfigToLog` creates a new <<copyKafkaConfigToLog-log-properties, log properties>> based on the values in the given <<kafka-server-KafkaConfig.adoc#, KafkaConfig>>.
