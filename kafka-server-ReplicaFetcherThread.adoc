...
NOTE: `truncate` is a part of link:kafka-AbstractFetcherThread.adoc#truncate[AbstractFetcherThread Contract].
...
NOTE: `truncateFullyAndStartAt` is a part of link:kafka-AbstractFetcherThread.adoc#truncateFullyAndStartAt[AbstractFetcherThread Contract].
