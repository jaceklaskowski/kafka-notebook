...
NOTE: `becomeLeaderOrFollower` is used exclusively when `KafkaApis` is requested to <<kafka-KafkaApis.adoc#handleLeaderAndIsrRequest, handle LeaderAndIsr request>>.
