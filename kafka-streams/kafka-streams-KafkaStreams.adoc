...
NOTE: `KafkaStreams` is "merely" a <<clientSupplier, Kafka client>> that consumes messages from one or many Kafka topics and publishes the processing results to zero, one or more Kafka topics.
