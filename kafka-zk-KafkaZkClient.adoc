...
=== [[createTopicPartitionStatesRaw]] `createTopicPartitionStatesRaw` Method
...
`createTopicPartitionStatesRaw`...FIXME

NOTE: `createTopicPartitionStatesRaw` is used when...FIXME
